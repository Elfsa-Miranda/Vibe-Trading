...
def test_every_registered_payload_schema_validates_a_complete_production_shape() -> None:
    ...
    samples: dict[str, dict[str, object]] = {
        "TrialStarted": {
            ...
            "ProcessActionFrozenV2": {
                "action_id": "action-v2-1", "trial_id": "trial-1",
                "parent_factor_spec_id": "factor-1", "candidate_id": "candidate-1",
                "base_expected_utility": 0.1, "eligible_event_watermark": digest,
                "policy_hash": digest, "utility_policy_hash": digest,
                "data_snapshot_hash": digest, "regime_config_hash": None,
                "run_group_id": "run-group-1", "seed": 7,
                "candidate_budget": 10, "frozen_at": timestamp,
            },
            "ProcessOutcomeRecordedV2": {
                "outcome_id": "outcome-v2-1", "action_id": "action-v2-1",
                "trial_id": "trial-1", "terminal_event_hash": digest,
                "evaluation_event_hash": digest, "derivation_event_hash": digest,
                "data_scope": "valid", "child_factor_spec_id": "factor-2",
                "observed_validation_utility": 0.2, "scorecard_hash": digest,
                "utility_policy_hash": digest,
                "ast_diff": {"schema_version": "ast_diff.v1"},
                "ast_diff_hash": digest, "available_at": timestamp,
                "policy_hash": digest, "data_snapshot_hash": digest,
                "regime_config_hash": None, "run_group_id": "run-group-1",
            },
        "GenerationFailureRecorded": {
            "trial_id": "trial-1",
